    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('charge_type', models.SmallIntegerField(choices=[(1, '充值'), (2, '扣款'), (3, '创建订单'), (4, '删除订单'), (5, '撤销订单')], verbose_name='类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('count', models.IntegerField(verbose_name='数量')),
                ('price', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='价格')),
                ('real_price', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='实付价格')),
